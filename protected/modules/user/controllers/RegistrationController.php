		...
		if (Yii::app()->user->id) {
		    ...
		    if(isset($_POST['RegistrationForm'])) {
				...
				if($model->validate())
				{
					...
					$model->activkey=UserModule::badHasher(microtime().$model->password);
					$model->password=UserModule::hasher($model->password);
					$model->verifyPassword=UserModule::hasher($model->verifyPassword);
